...
def evaluate_test(context_tower, loader, candidate_embs, candidate_ids, device):
    """
...
def main():
    ...
    # --- Evaluation (grouped: see evaluate() docstring above) ---
    metrics = evaluate(context_tower, test_loader, candidate_embs, all_candidate_ids, device)
